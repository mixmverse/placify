    ...
    <main className="relative flex min-h-full flex-1 items-center justify-center px-6 py-12">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
          ...
          <p className="mt-2 text-center text-sm text-white/40">Sign in to your Placify account</p>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs"><span className="bg-transparent px-3 text-white/20">or continue with</span></div>
          </div>

          <button
            onClick={() => signIn("google", { callbackUrl })}
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-white/10 bg-white/5 px-5 py-3 text-sm font-medium text-white/70 transition-all hover:border-white/20 hover:bg-white/[0.07] hover:text-white"
          >
