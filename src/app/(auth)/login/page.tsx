    ...
    <main className="flex min-h-full flex-1 items-center justify-center px-6 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          <h1 className="text-center text-2xl font-semibold text-black dark:text-white">Welcome back</h1>
          <p className="mt-2 text-center text-sm text-zinc-500">Sign in to your Placify account</p>

          <div className="mt-6 space-y-3">
            {/* Quick-login buttons */}
            <button
              onClick={() => signIn("credentials", { email: "artist@example.com", callbackUrl: "/dashboard/artist" })}
            ...
            >
              🎵 Continue as Artist (demo)
            </button>
            <button
              onClick={() => signIn("credentials", { email: "curator@example.com", callbackUrl: "/dashboard/curator" })}
              className="flex w-full items-center justify-center gap-3 rounded-full border border-zinc-300 bg-white px-5 py-3 text-sm font-medium transition-colors hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 dark:hover:bg-zinc-800"
            >
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs"><span className="bg-white px-2 text-zinc-400 dark:bg-zinc-950">or continue with</span></div>
            </div>

            <button
              onClick={() => signIn("google", { callbackUrl: "/dashboard/artist" })}
              className="flex w-full items-center justify-center gap-3 rounded-full bg-black px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-zinc-800 dark:bg-white dark:text-black"
            >
