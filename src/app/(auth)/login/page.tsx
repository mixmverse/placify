...
function LoginForm() {
  ...
  const callbackUrl = params.get("callbackUrl") ?? "/dashboard/artist";
      ...
      <div className="w-full max-w-md">
        <Link href="/" className="mb-8 flex items-center justify-center gap-2 text-xl font-bold tracking-tight text-black dark:text-white">
          <svg viewBox="0 0 40 40" width="28" height="28">
            ...
            <path d="M20 4 C14.5 4 10 8.5 10 14 C10 21 20 31 20 31 C20 31 30 21 30 14 C30 8.5 25.5 4 20 4Z" fill="url(#lg)"/>
